                 ...
                 <Stack direction="column" justifyContent="center" sx={{ height: "100%", ml: { md: 2 } }}>
                   ...
                   <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1.5 }}>
                      {Object.entries(
                        ...
                        const palette = eventColors[type] ?? getDefaultPalette(type);
                        return (
                  ...
                  >
                    ...
                    <Stack spacing={0.4}>
                      {dayEvents.map((eventItem) => {
                        const palette = eventColors[eventItem.eventTypeName] ?? getDefaultPalette(eventItem.eventTypeName);
                        return (
                          <Box
